          ...
          if (!innerColorWasSet) {
            ...
            that.innerColor = function(x, y) {
              if (x < stream.position / stream.durationEstimate) {
                return options.playedColor || "rgba(255,  102, 0, 0.0)"; // changed from 0.8
              } else if (x < stream.bytesLoaded / stream.bytesTotal) {
                return options.loadedColor || "rgba(241, 241, 241, 0.9)"; // change from 0, 0, 0, 0.8
              } else {
                return options.defaultColor || "rgba(241, 241, 241, 1)";
              }
            };
